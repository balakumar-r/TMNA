...
/**
 * Gets footer variation class from block.
 * Example:
 * footer-brand
 * footer-pref
 * footer-privacy-left
...
function decorateFooterBlock(footerBlock) {
  ...
  if (
    blockClass === 'footer-privacy-left'
    || blockClass === 'footer-privacy-right'
  ) {
...
export default async function decorate(block) {
  ...
  const footerBlocks = block.querySelectorAll(
    '.columns.block[class*="footer-"]',
  );
